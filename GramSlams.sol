...
contract GramSlams is ERC20, Ownable {
    ...
    address public _rewardWallet = 0xa6C537A2544685424924a9CA56175a2d363A3317;
    address public _marketingWallet = 0xc1392F86fF5d39D7A69Cdc583065F4836bED42a3;

    // Tax System

    uint256 public _feeBuyTotal = 3;

    uint256 public _feeBuyReward = 2;
    uint256 public _feeBuyMK = 1;


    uint256 public _feeSellTotal = 3;

    uint256 public _feeSellReward = 2;
    uint256 public _feeSellMK = 1;
    ...
    constructor() ERC20("GramSlams", "GSlam") {
    ...
    function editBuyFees(
        ...
        _feeBuyTotal = __feeBuyReward + __feeBuyMK;
    }
    ...
    function editSellFees(
        ...
        _feeSellTotal = __feeSellReward + __feeSellMK;
    }
}
